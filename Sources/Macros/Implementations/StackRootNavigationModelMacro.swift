...
public struct StackRootNavigationModel: ExtensionMacro, MemberMacro, MemberAttributeMacro {
    ...
    public static func expansion(
        ...
        [
            try ExtensionDeclSyntax("@MainActor extension \(type.trimmed): StackRootNavigationModel {}")
        ]
    }
}
