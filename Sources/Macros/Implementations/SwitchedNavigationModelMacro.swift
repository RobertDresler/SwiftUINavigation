...
public struct SwitchedNavigationModel: ExtensionMacro, MemberMacro, MemberAttributeMacro {
    ...
    public static func expansion(
        ...
        return [
            DeclSyntax(
                ...
                \(accessModifier) var isWrapperModel: Bool { false }
                deinit {
    ...
    public static func expansion(
        ...
        [
            try ExtensionDeclSyntax("@MainActor extension \(type.trimmed): SwitchedNavigationModel {}")
        ]
    }
}
